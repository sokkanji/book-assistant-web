...
<body>
    ...
    <div id="project">
        <h1>뉴스레터</h1>
        <hr class="p-hr">
        <p>독립서점뿐만 아니라 소규모 책방의 흥미로운 소식을 편하게 이메일로 받아보세요!</p>
        ...
        <div class="p-detail">
            <details>
                ...
                <div class="content">1960-70년대에는 약 200개의 헌책방이 가득했고 하루 평균 2만명 사람들이 다녀갔던 헌책방 거리였다. 책과 참고서를 구하기 어렵던
                    ...
                    들어서는
                    교과서가 수시로 개정되기 때문에 헌책의 가치는 떨어졌기 때문이다.</div>
            ...
            <details>
                ...
                <div class="content">현재 텐바이텐 대학로점에는 자판기는 없지만 라이브러리 컨셉으로 제품이 진열 판매되고 있으며, 비슷하게 현대백화점 신촌점에도 무인 서점
                    형태를
                    한
                    ‘설렘서점’이 운영 중이다. 모든 프로젝트로 얻은 수익은 입점 수수료를 제외하고는 전액 청계천 헌책방거리를 살리는 데에 사용되고 있다. 헌책방을 활성화시키는
                    한편으로,
                    사람들에게
                    일상의 설렘을 주고 싶다는 이들의 행보는 그 자체로 큰 선물 같은 존재다.
                    <div class="home_link">
            ...
            <details>
                ...
                <div class="content">서울 도서관은 헌책방 운영을 도와 지역경제를 활성화하고자, 2015년부터 매년 '청계천 헌책방거리 책 축제'를 개최한다. 2018년
                    ...
                    잊혀진
                    헌책방과
                    서울시민들의 접점을 늘리기 위한 서울시와 서울도서관들의 노력들이다.
                </div>
            ...
            <details open>
                ...
                <div class="content">
                    ...
                    쏜살문고가
                    '특별판'을
                    생산하고, 독립 서점들의, 의견을 물은 후 손해 볼 각오를 하고 동네 서점 특별판 프로젝트를 실험적으로 진행했다.
