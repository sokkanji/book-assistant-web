    ...
    <div class="menubar">
            ...
            <ul class="dropdown">
                <li class="mb01">
                    ...
                    <ul class="m2">
                        ...
                        <li><a href="./book_search.php">독립출판물 검색</a></li>
                    </ul>
                </li>
                <li class="mb02">
                    <a href="./book_test.php" class="m1">추천</a>
                    <ul class="m2">
                        <li><a href="./book_test.php">인생책 찾기 테스트</a></li>
                        <li><a href="./recommend.php">독립출판물 추천</a></li>
                    </ul>
                </li>
                <li class="mb03">
                    <a href="./watching.php" class="m1">소식</a>
                    <ul class="m2">
                        <li><a href="./watching.php">독립서점 구경하기</a></li>
                ...
                <li class="mb04">
                    ...
                    <ul class="m2">
                        ...
                        <li><a href="./report_html.php">제보하기</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <?php
            if(!isset($_SESSION["email"])) { 
                echo "<div><a href='./login.php' id='login-img'><img src='./public/img/login_icon.png'
                alt='로그인 이미지'></a></div>";
            }
            else{
